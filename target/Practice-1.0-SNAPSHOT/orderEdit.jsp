...
//                customerId = connector.getCustomerID(email, password);
        ...
        %>       
                    ...
                    <tr><td>Email Address :</td><td><input id="edit_email_address" value="<%= getAnonymous.getEmail()%>" name="updateEmail" required></td>
                        <td>Mobile Phone :</td><td><input id="edit_mobile_address" value="<%= getAnonymous.getPhoneNumber()%>" name="updatePhone" required></tr>
                ...
                <table>
                    ...
                    <tr><td>Expiry date</td>
                        ...
                        <select id = "edit_payment_expiry_year" value="<%=getPayment.getExpiryYear()%>" name="updateExpiryyear">
