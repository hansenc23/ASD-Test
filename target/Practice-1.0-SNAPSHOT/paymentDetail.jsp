...
<html>
    ...
    <body>
        ...
        %>
                    ...
                    <tr><td>First name(s)</td><td><input type = "text" name = "cardfname" ></td>
                        <td>Last name</td><td><input type = "text" name = "cardlname" ></td></tr>
                    <tr><td>Card number</td><td>
                                    <input type ="text" name = "cardnumber" minlength="16" maxlength="16" ></td></tr>
                    <tr><td>Expiry date</td>
                        ...
                        <td>CVV</td>
                        <td><input type = "text" name = "cvv" minlength="3" maxlength="3" size = "1" ></td></tr>
