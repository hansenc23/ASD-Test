    ...
    <body>
       <%
        ...
        <div class="editprofile">
                ...
                <h3 style="text-align: center">Are you sure you want to remove User: <%=userID%> ?</h3>
                <table class="editdetails">
                    ...
                    <tr>
                        <td align="center"><button id="update_button" class="button-secondary pure-button" onclick="location.href = 'accountList.jsp'"> Back </button></td>
                    <form action="deleteSuccess.jsp" method="post">
                        <td align="center"><button id="delete_button" class="button-error pure-button" type="submit"> Delete </button></td>
