...
//                customerId = connector.getCustomerID(email, password);
        ...
        %>       
                    <tr><td>First Name : </td><td><input value="<%= getAnonymous.getFirstName()%>" name="updateFname" required></td>
                    <td>Last Name : </td><td><input value="<%= getAnonymous.getLastName()%>" name="updateLname" required></td></tr>
                    <tr><td>Email Address :</td><td><input value="<%= getAnonymous.getEmail()%>" name="updateEmail" required></td>
                        <td>Mobile Phone :</td><td><input value="<%= getAnonymous.getPhoneNumber()%>" name="updatePhone" required></tr>
                    <tr><td>Address :</td><td><input value="<%= getAnonymous.getAddress()%>" name="updateAddress" required></td></tr>
                </table>
                <hr>
                <table>
                ...
                <hr>
                <table>
                    <tr><td>First name(s) :</td><td><input value="<%=getPayment.getFirstName()%>" name="updateFirstname" required></td>
                        <td>Last name :</td><td><input value="<%=getPayment.getLastName()%>" name="updateLastname" required></td></tr>
                    <tr><td>Card number</td><td>
                                    <input type ="text" value="<%=getPayment.getCardNumber()%>" name="updateCardnum" minlength="16" maxlength="16" required></td></tr>
                    <tr><td>Expiry date</td>
                        <td>
                        <select value="<%=getPayment.getExpiryMonth()%>" name="updateExpirymonth">
                        ...
                        <select id = "epxiryyear" value="<%=getPayment.getExpiryYear()%>" name="updateExpiryyear">
                        ...
                        <td>CVV</td>
                        <td><input type = "text" value="<%=getPayment.getCvv()%>" name="updateCvv" minlength="3" maxlength="3" size = "1" required></td></tr>
        <%    
            }
            else{
        ...
        %>
                <tr><td colspan = "3"></td><td align = "right"><input type="submit" value="Edit" name = "change"></td></tr></tr>
                </table>
                </div>
    </body>
</html>
