...
//            session.removeAttribute("addCusId"); 
        ...
        %>
            <form method = "post" action = "orderConfirmation.jsp" >
                    <tr><td>First name(s)</td><td><input id = "cardfname" type = "text" name = "cardfname" required></td>
                        <td>Last name</td><td><input id = "cardlname" type = "text" name = "cardlname" required></td></tr>
                    <tr><td>Card number</td><td>
                                    <input id = "cardnumber" type ="text" name = "cardnumber" minlength="16" maxlength="16" required></td></tr>
                    <tr><td>Expiry date</td>
                        ...
                        <select id = "epxiryyear" name = "expiryyear">
