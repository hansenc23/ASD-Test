...
//        driver.findElement(By.id("update_email")).sendKeys("testing101@gmail.com");
//        driver.findElement(By.id("update_firstname")).clear();
//        driver.findElement(By.id("update_firstname")).sendKeys("Lee");
//        driver.findElement(By.id("update_lastname")).clear();
//        driver.findElement(By.id("update_lastname")).sendKeys("Sin");
