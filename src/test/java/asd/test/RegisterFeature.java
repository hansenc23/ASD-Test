...
public class RegisterFeature extends Driver{
    ...
    public void User_fill_in_the_registration_detail() {
        ...
        driver.findElement(By.id("register_email")).sendKeys("hansenTesting13456@gmail.com");
    ...
    public void user_fills_login_credentials() {
        driver.findElement(By.id("login_email")).sendKeys("hansenTesting13456@gmail.com");
