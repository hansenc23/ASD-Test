...
//            driver.findElement(By.id(inputField)).sendKeys("2019/09/26");
//        } else {
//            switch(inputField) {
//                case "fromOpalID":
...
//        String[] input = {"7777 8888 7777 8888", "1111 2222 1111 2222", "10.00"};
...
//        int shownTransfers = driver.findElements(By.name("fromOpalID")).size();
...
//        String searchedDate = "26-09-2019";
