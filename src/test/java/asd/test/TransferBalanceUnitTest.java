...
//        String transferDate = dateFormat.format(date);
//        String resultSearchDate = connector.testTransferHistory(transferDate, "TransferDate");
//        String customerID = connector.getCustomerID("my@gmail.com", "123456");
//        String resultShowAll = connector.testTransferHistory(customerID, "CustomerID");
